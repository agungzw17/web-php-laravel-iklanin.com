...
<div class="container my-5">
    <nav class="my-4 text-primary" style="margin-left: -40px">
        <ol>
            ...
            <li class="d-inline" aria-current="page">List Iklan</li>
        </ol>
    </nav>
    <h4>List Iklan</h4> <br>
    <table class="table">
        ...
        @foreach($post as $posts)
            <tr>
                ...
                <td>{{ \App\Appliance::where(['post_id' => $posts->id])->where(['status' => 2])->pluck('id')->count('id') + \App\Appliance::where(['post_id' => $posts->id])->where(['status' => 3])->pluck('id')->count('id') }}</td>
                <td>
                            ...
                            <div class="modal-content">
                                ...
                                <br>
                                    <form action="{{route('post.update', $posts->id)}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="text-danger">* Detail Konten</div> <br>
                                        <div class="form-group">
                    ...
                    <a href="{{ route('applianceList', $posts->id) }}">
